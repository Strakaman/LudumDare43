...
public class EnemyHealth : MonoBehaviour
{
    ...
    bool isSinking;                             // Whether the enemy has started sinking through the foor.
    float lastTimeHitAudioWasPlayed = 0f;
    readonly float AUDIO_REPEAT_FREQUENCY = 2f;
